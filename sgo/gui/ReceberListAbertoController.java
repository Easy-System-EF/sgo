...
public class ReceberListAbertoController implements Initializable, DataChangeListener {
...
// auxiliar 	
 	...
 	String nomeTitulo = "Consulta Contas a Receber";
 	String opcao = "t";
...
// injeta a dependencia com set (inversão de controle de injeçao)	
	...
	ParPeriodo objPer = new ParPeriodo();
 	...
 	public void onBtClienteAction(ActionEvent event) {
		...
		nomeTitulo = "Contas a Receber por Cliente";
		opcao = "c";
		classe = "Cliente";
	...
	public void onBtPeriodoAction(ActionEvent event) {
		Stage parentStage = Utils.currentStage(event);
		nomeTitulo = "Contas a Receber por Periodo";
		opcao = "p";
		classe = "Periodo";
